...
- [Table of contents](#table-of-contents)
  ...
  - [General assumptions](#general-assumptions)
    ...
    - [Model-code gap](#model-code-gap)
      - [Placing on hold](#placing-on-hold)
      - [Spring](#spring)
    - [Tests](#tests)
  ...
  - [How to Build](#how-to-build)
    ...
    - [Build a Jar package](#build-a-jar-package)
    - [Build with Docker](#build-with-docker)
    - [Production ready metrics and visualization](#production-ready-metrics-and-visualization)
